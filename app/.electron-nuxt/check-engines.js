...
// NOTE: Does not work when using NVM and installing Yarn through NPM—just shows the path to NPM
function disallowNpm() {
  ...
  if (!execPath.includes('yarn')) {
    ...
    console.warn(
      `Please use Yarn to run Electron-nuxt.\n Detected: ${process.env.npm_execpath}`
    )
