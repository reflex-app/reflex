  ...
  <div class="empty-state">
    ...
    <section class="grid-2-up">
      <div>
        <h3>Screens</h3>
        <p>
          You can easily see how your site will look at a specific size by using
          Screens.
        </p>
        <p>Create new Screens in the Screens panel on the left.</p>
        <p>
          Tip: use at least 2-3 Screens. You can also create screen sizes from
          common front-end libraries, like Bootstrap and Foundation using the
    ...
    <section class="grid-2-up">
      <div>
        ...
        <p>
          Enable the Sync toggle to synchronize clicks, scrolling, and other
          events across all of your Screens.
        </p>
        <p>
          There’s no better way to see how your site will work at different
          sizes.
        </p>
    ...
    <section class="grid-2-up">
      <div>
        ...
        <p>
          You can easily take responsive screenshots right from {{ appName }}.
        </p>
        <p>
          Drag to select which screens on the canvas you want, and then either
          save them as images, or copy to clipboard.*
        </p>
    ...
    <section class="text-section-centered">
      ...
      <p>
        {{ appName }} is a free, open-source project, maintained by the web
        community to make a better web experience for everyone.
      </p>
      <p>
        Interested in learning about making responsive websites, or letting us
        know how much you enjoy using {{ appName }}? We’re
        <a href="https://twitter.com/reflex_app">@reflex_app</a> on Twitter.
      </p>
