const scroll = (origin, x, y) => {
    ...
    const scrollProportionY = () => {
        ...
        const localViewportHeight = Math.max(document.documentElement.clientWidth, window.innerWidth || 0)
        return percentage * (document.documentElement.scrollHeight - localViewportHeight)
    }
